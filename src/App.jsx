  ...
  return (
    <>
      <div className="center">
        <h2 className="mb-3">Check internet Connection Speed</h2>


        {started == true ? <Speedometer /> : (
          <a href="#" onClick={() => getStarted()} className="start-btn">
            <span className="start-ring"></span>
            <span className="start-border"></span>
            <span className="start-text">Go</span>
          </a>
        )}
        {ipAddress &&
          <div className="df ips">
            ...
            <div className="ip-info">
              ...
              <p className="ip-info-address">{ipAddress.query}</p>
            </div>
          </div>
        }
      </div>
      <p class="createdby">created by <a href="https://t.me/ubuntuous">@ubuntuous</a></p>
